...
#+begin_src emacs-lisp
    ...
    '("/Users/atanas/Library/texmf/bibtex/bib")) ; Not sure this works

    ;; Default bibliography
    (setq reftex-default-bibliography
    '("/Users/atanas/.pandoc/MyLib.bib")) ; update file path
#+end_src
...
* Atanas' Custom elements
Some atanas tweaks.

#+srcname: atanas-custom
#+begin_src emacs-lisp
  ;; load drag-stuff
  ...
  :ensure t)
  ;; the below two lines were only used when install 'font-lock+, since disabled and saves on startup
  ;; :quelpa
  ...
  ;; more easily navigate and manage projects
  ;; need to review for propoer keybindings
  ;; load projectile
  ;; (require 'projectile)
  ;; (define-key projectile-mode-map (kbd "C-S-c p") 'projectile-command-map)
  ;; (projectile-mode +1)
  (use-package projectile
    :bind ("C-S-c p" . projectile-command-map))
    :init
    (projectile-mode +1)
  ...
  ;; load relevant packages with use-package below
  ;; (use-package awesome-tab
  ;; :load-path "/Users/atanas/.emacs.d/atanas/awesome-tab.el"
  ;; :config
  ;; (awesome-tab-mode t))

  ;; enable standard dashboard
  (use-package dashboard
    ...
    ;; customise which widgets are displayed
